...
function loadIndexPage(){	
	...
	document.getElementById('lefteye21').style.top = "50px";
	document.getElementById('lefteye21').style.left = "400px";
	...
	document.getElementById('righteye21').style.top = "50px";
	document.getElementById('righteye21').style.left = "400px";
...
function loadBtns(){
	...
	document.getElementById('lefteye21').style.backgroundImage = "url('images/" + randomOC + "/lefteye/21.png')";
	...
	document.getElementById('righteye21').style.backgroundImage = "url('images/" + randomOC + "/righteye/21.png')";
...
function LeftEyeButton(no){
	...
	document.getElementById('lefteye21').style.backgroundColor = "#212121";
	lefteye = no;
	...
	if (resetEyes == 1){
		...
		document.getElementById('righteye21').style.backgroundColor = "#212121";
...
function updateAll(){
	...
	}else if (lefteye == "lefteye21"){
		resetEyes = 1;
		document.getElementById('ocLeftEye').style.backgroundImage = "url('images/" + randomOC + "/oc/lefteye/20.png')";
	}
	...
	}else if (righteye == "righteye21"){
		resetEyes = 1;
		document.getElementById('ocRightEye').style.backgroundImage = "url('images/" + randomOC + "/oc/righteye/20.png')";
	}
...
function resetAll(){ // Change values to change default face
	blush = "blushoff";
	cry = "cryoff";
	mouth = "mouth1";
	lefteye = "lefteye1";
