...
var verNo2 = "2017 <a href='http://littlebolt.me' target='_blank'>Little Bolt</a> | Not affiliated with <a href='https://pony.town' target='_blank'>Pony.Town</a><br><a href='https://pony.town' target='_blank'>Pony.Town</a> is &copy; <a href='https://twitter.com/Agamnentzar' target='_blank'>Agamnentzar</a>";
...
var cry = "cryoff";
var mouth = "mouth1";
var lefteye = "lefteye1";
var righteye = "righteye1";
var brows = "browsoff";
var eyes = "eyes1";
...
function loadIndexPage(){	
	...
	document.getElementById('ocBlush').style.backgroundImage = "url('images/" + randomOC + "/oc/blush.png')";
	//document.getElementById('ocCry').style.backgroundImage = "url('images/" + randomOC + "/oc/cry.png')";
	document.getElementById('ocTear').style.backgroundImage = "url('images/" + randomOC + "/oc/botheyes/tear.png')";
...
function closePic(){
	...
	ocument.getElementById('savePicBox').innerHTML = "";
}
